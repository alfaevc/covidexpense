...
#
write.csv(cdc_all,"data/cdc_all.csv")
write.csv(cdc_monthly_all_state,"data/cdc_monthly_all_state.csv")
write.csv(cpi_monthly,"data/cpi_monthly.csv")
write.csv(data_monthly,"data/data_monthly.csv")
```
