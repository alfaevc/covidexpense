...
```{r}
plot_states(cdc.month, c("WA","PA","NY","CA"), "new_case", "Covid Monthly New Cases Time Series")
```
...
```{r}
Bcoef.mat = plot.bspline(cdc.month, all.states, 'new_case', n.knots=15, degree=3)
wss <- function(k) {
