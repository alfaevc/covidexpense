...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
all.states = unique(cdc.month$state)[1:50]
state.col = rainbow(length(all.states))
```



```{r all spline, message=FALSE, warning=FALSE, echo=FALSE, results='hide', fig.show='hide'}
...
```{r us region map, message=FALSE, warning=FALSE, echo=FALSE, fig.show='hide'}
# us map on regions
